...
protected:
  ...
  G4VPhysicalVolume* PHe2;              //Physical volume for this detector


  //private:
  GarfieldG4FastSimulationModel* garfieldModelLHe1;
  GarfieldG4FastSimulationModel* garfieldModelLHe2;
  GarfieldMessenger* fGarfieldMessenger;
  
};


inline const G4VPhysicalVolume* RTPC::GetGasPV() const  {
  return PHe2;
}
