...
G4VPhysicalVolume* RTPC::Construct(G4LogicalVolume* maw){
  ...
  G4Region* regionGarfieldLHe2 = new G4Region("regionGarfieldLHe2");
  regionGarfieldLHe2->AddRootLogicalVolume(fLHe2);
  garfieldModelLHe2 = new GarfieldG4FastSimulationModel("regionGarfield", regionGarfieldLHe2);
