 ...
 while ((*theParticleIterator)()) {
	  ...
	  G4LossTableManager::Instance()->SetVerbose(1);
	 	  ...
	 	  // G4PAIPhotModel* paiPhot = new G4PAIPhotModel(particle,
	  	  // 					       "G4PAIPhotModel");
	  	   G4PAIModel* paiPhot = new G4PAIModel(particle,
	  					       "G4PAIModel");
	  ...
	  if (particle->GetParticleName() == "e-"
	    ...
	    config->SetExtraEmModel(particle->GetParticleName(), "eIoni",
	    			    paiPhot, "regionGarfieldLHe2", 0.01 * keV, 100. * TeV, paiPhot);//orig 0.01 * keV	    
	    ...
	    config->SetExtraEmModel(particle->GetParticleName(), "ionIoni", paiPhot,
	    			    "regionGarfieldLHe2", 0.01 * keV, 100. * TeV, paiPhot);//orig 0.01 * keV	    
	  }

		
	}//while particle iterator
...
void PhysicsList::SetCuts()
{
  ...
  G4ProductionCutsTable::GetProductionCutsTable()->SetEnergyRange(100.0 * eV,
								  100. * TeV);
  SetCutsWithDefault();

  // G4Region *region = G4RegionStore::GetInstance()->GetRegion("regionGarfieldLHe2");
  G4Region *region = G4RegionStore::GetInstance()->GetRegion("regionGarfieldLHe2");
